...
Release status: direct checkout commands are the source of truth until `node ./bin/proofroute.js profile --check-public` reports public GitHub and npm visibility.
